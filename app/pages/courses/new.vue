          ...
          <div class="space-y-4 order-1 lg:order-2">
            ...
            <div>
              ...
              <p class="text-xs text-(--sub-color) mt-1">
                Optional: Set a start time if this course is for a specific race
              </p>
            </div>
              ...
              <div v-if="previewStats" class="mt-4">
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  ...
                  >
                    ...
                    <p class="text-lg font-semibold text-(--main-color) mt-1">
                ...
                >
                  No elevation samples found in file; gain/loss unavailable.
                </p>
              </div>

              <ElevationProfilePreview :geo-json="processedFile.geoJson" />
            </div>
          </div>
        </div>
      </div>
